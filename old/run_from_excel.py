...
#   corpse_boolean, lock_block_boolean, map_applied_boolean, passives_per,
#   passives_to_add, spells_per, spells_to_add, health_override,
#   apply_base_armor_class (alias: apply_base_ac), ac_boost
#
# clear_stats recognised headers:
#   #, status, monster_archetype_match, class_archetype_match, subtype_match,
#   act_match, location_match, type_match, handle_match, full_guid_match,
#   corpse_boolean, lock_block_boolean, map_applied_boolean, clear_passives,
#   clear_spells, clear_health
...
def _process_alter_sheet(ws, blocks):
    ...
    for row_idx in range(2, ws.max_row + 1):
        ...
        blocks = alterStatistics.alter_stats_by_field_combo(
            ...
            lock_block_boolean=_bool_or_none(col("lock_block_boolean")),
            map_applied_boolean=_bool_or_none(col("map_applied_boolean")),
